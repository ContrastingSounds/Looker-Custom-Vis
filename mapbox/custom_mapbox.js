...
const vis = {
    ...
    updateAsync: function(data, element, config, queryResponse, details, done) {
        ...
        map.on('load', function() {
            for (let d = 0; d < dimensions.length; d++) {
                if (dimensions[d].tags.includes("geojson")) {
                    // let source_name = dimensions[d].name+"-source";
                    // let map_source = {
                    //     "type": "geojson",
                    //     "data": {
                    ...
                    //     }
                    // }
                    // map.addSource(source_name, map_source);
                    ...
                    for (let row = 0; row < data.length; row++) {
                        ...
                        // }
                        // map_source.data.features.push(feature);
                    ...
                    // console.log("map_source.data.features", map_source.data.features)
                    // dumpToConsole("map_source", map_source);
                    // let layer_name = dimensions[d].name + "-layer";
